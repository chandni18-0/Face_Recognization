...
class Face_Recognition:
    def __init__(self,root):
        ...
        #left image
        img_top=Image.open(r"C:\Users\HP\Desktop\attendance\pic6.jpg")
        ...
        img_bottom = Image.open(r"C:\Users\HP\Desktop\attendance\pic7.jpg")
        ...
        #button
        b1_1=Button(f_lbl,text="Face Detector",command=self.face_recog,cursor="hand2",font=("times new roman",20,"bold"),bg="darkgreen",fg="white")
        b1_1.place(x=365,y=620,width=220,height=43)
